...
import { DoorOpen, ChevronRight, CheckCircle } from "lucide-react";
...
const InfoKamar4 = ({ roomId = 4 }: { roomId?: number }) => {
    ...
    <div className="space-y-6">
      ...
      <div className="p-4 rounded-lg bg-[#FFF8E7] border border-[#FFE180] shadow-md">
        ...
        <p className="mt-2 text-gray-700">
          {kamar.description || "No description available"}
        </p>
      </div>
    </div>
  );
